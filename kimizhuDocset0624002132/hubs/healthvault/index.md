                ...
                <ul id="overview">
                    <li>
                        ...
                        <ul id="introduction" class="cardsC">
                            <li>
                                <a href="/healthvault/why-healthvault?branch=microsoft/develop">
                                    <div class="cardSize">
                            ...
                            <li>
                                <a href="/healthvault/technical-overview?branch=microsoft/develop">
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                <div class="cardImageOuter">
                            ...
                            <li>
                                <a href="/healthvault/interoperability?branch=microsoft/develop">
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                <div class="cardImageOuter">
                            ...
                            <li>
                                <a href="/healthvault/hipaa-and-hitech?branch=microsoft/develop">
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                <div class="cardImageOuter">
                    ...
                    <li>
                        ...
                        <ul id="scenarios" class="cardsC">
                            <li>
                                <a href="/healthvault/action-plans?branch=microsoft/develop">
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                <div class="cardImageOuter">
                            ...
                            <li>
                                <a href="/healthvault/meaningful-use?branch=microsoft/develop"><div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                <div class="cardImageOuter">
                                                    <div class="cardImage bgdAccent1">
                            ...
                            <li>
                                <a href="/healthvault/emergency-preparedness?branch=microsoft/develop">
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                <div class="cardImageOuter">
                    ...
                    <li>
                        ...
                        <ul id="publishing" class="cardsC">
                            <li>
                                <a href="/healthvault/become-a-solution-provider?branch=microsoft/develop">
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                <div class="cardImageOuter">
                            ...
                            <li>
                                <a href="/healthvault/brand-materials?branch=microsoft/develop">
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                <div class="cardImageOuter">
                            ...
                            <li>
                                <a href="/healthvault/go-live?branch=microsoft/develop">
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                <div class="cardImageOuter">
                            ...
                            <li>
                                <a href="/healthvault/updates?branch=microsoft/develop">
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                <div class="cardImageOuter">
                            ...
                            <li>
                                <a href="/healthvault/territories?branch=microsoft/develop">
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                <div class="cardImageOuter">
                            ...
                            <li>
                                <a href="/healthvault/nhs?branch=microsoft/develop"><div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                <div class="cardImageOuter">
                                                    <div class="cardImage bgdAccent1">
                                ...
                                <div class="cardSize">
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                <h3>
                                                    <a href="/healthvault/apis/rest-overview?branch=microsoft/develop">Get started with REST</a>
                                                </h3>
                                                <p>
                                ...
                                <div class="cardSize">
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                <h3>
                                                    <a href="https:/healthvaultjavalib.codeplex.com/">Get the Java SDK</a>
                                                </h3>
                                            </div>
                                        </div>
                                    </div>
